...
def main():
    ...
    current_closing_prices, first_closing_prices = fetch_closing_prices(tickers, report_type)

    email_sender = EmailSender()
    email_message = email_sender.create_message(subject, current_closing_prices, first_closing_prices)
